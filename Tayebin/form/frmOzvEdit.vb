...
Public Class frmOzvEdit
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        New SQLiteParameter("@7", txtTel.Text.Replace(" ", "")),
        New SQLiteParameter("@8", txtMob.Text.Replace(" ", "")),
        New SQLiteParameter("@9", txtMobPedar.Text.Replace(" ", "")),
        New SQLiteParameter("@10", txtMobMadar.Text.Replace(" ", "")),
